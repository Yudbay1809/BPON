...
import { fadeLeft, fadeRight, staggerContainer, staggerItem } from '@/hooks/use-scroll-animation';
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              className="absolute bottom-4 right-4 md:-bottom-6 md:-right-6 bg-primary text-white rounded-2xl p-4 md:p-6 shadow-xl max-w-[160px] md:max-w-[220px]"
